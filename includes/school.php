...
class School {
	...
	public static function find_by_id( $id=0) {
		global $database;
		$result_array = self::find_by_sql("SELECT * FROM high_school WHERE id={$id} LIMIT 1");
	...
	public function create() {
		...
		$sql = "INSERT INTO high_school (id,name,reg_no,board,year) VALUES ('";
